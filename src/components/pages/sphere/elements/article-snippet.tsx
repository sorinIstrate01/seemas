...
const ArticleSnippet = ({
  ...
  return (
    <Link
      className={cn(
        "flex flex-col md:flex-row md:h-[160px] w-full gap-4 group/article",
        className
      )}
      href={getArticleLink(data)}
    >
      <div className="w-full md:w-[240px] relative h-[240px] md:h-auto rounded-xl overflow-hidden border border-zinc-100">
        {data.image ? (
          <>
            <Image
              src={data.image}
      ...
      <div className="flex w-full md:w-auto md:flex-1 flex-col gap-3">
        ...
        <div className="w-full flex flex-col gap-1">
          ...
          <p className="text-body-s text-zinc-800 w-full line-clamp-2 xl:line-clamp-3 text-ellipsis">
            {data.description}
          </p>
        </div>
