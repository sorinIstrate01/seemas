  ...
  return (
    ...
    >
      ...
      <HeroHeader
        ...
        description="At SeemaS, we’re on a mission to simplify the complex world of global tax and valuation through innovative technology and sharp thinking. Our work is fast-paced, impactful, and designed to change the way the world does business."
        badge={{
          text: "Careers",
          leftIcon: <IconBriefcase className="text-blue-primary" />,
        }}
        titleClassName="xl:max-w-[958px]"
        descriptionClassName="md:max-w-[656px] xl:max-w-[842px] p-0 mb-10 md:mb-14 text-body-s md:text-body-xl"
